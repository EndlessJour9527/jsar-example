// Using global webglUtils from webgl-utils.js
// import * as  m4 from "m4-module";
import * as webglUtils from 'webgl-utils-module';
...
function main() {
  ...
  var canvas = gl.canvas || gl._screenCanvas;
  const length = 800;
  // canvas.width = length;
  ...
  console.log('canvas', canvas, 'isWebGL2', isWebGL2, canvasWidth, canvasHeight, clientWidth, clientHeight);
  ...
  // setup GLSL program
  var { vs, fs } = getShaderSoutce(isWebGL2, vs1, vs2, fs1, fs2);
  ...
  function drawScene() {
    ...
    gl.viewport(0, 0, canvasWidth, canvasHeight || 500);
