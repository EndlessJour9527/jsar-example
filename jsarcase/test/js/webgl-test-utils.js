...
function glEnumToString(glOrExt, value) {
  ...
  // JSAR Runtime compatibility: toSorted is ES2023, provide fallback for older environments
  if (typeof found.toSorted === 'function') {
    found = found.toSorted();
  } else {
    // Fallback: create a copy and sort it
    found = found.slice().sort();
  }
  return found.join('/');
}
{
...
var replaceParams = function(str) {
  console.log('replaceParams called with string:', str);
  // JSAR Runtime compatibility: Check if str is valid
  if (str === undefined || str === null) {
    console.warn('replaceParams called with undefined/null string, returning empty string');
    return '';
  }
  if (typeof str !== 'string') {
    console.warn('replaceParams called with non-string argument:', typeof str, str);
    str = String(str);
  }
...
// JSAR Runtime compatibility: Ensure WebGLTestUtils is available globally
if (typeof window !== 'undefined') {
  window.WebGLTestUtils = WebGLTestUtils;
}
if (typeof global !== 'undefined') {
  global.WebGLTestUtils = WebGLTestUtils;
}
if (typeof globalThis !== 'undefined') {
  globalThis.WebGLTestUtils = WebGLTestUtils;
}

console.log('WebGLTestUtils loaded and exported globally:', typeof WebGLTestUtils);
console.log('WebGLTestUtils available in window:', typeof window !== 'undefined' ? typeof window.WebGLTestUtils : 'N/A');
console.log('WebGLTestUtils available in global:', typeof global !== 'undefined' ? typeof global.WebGLTestUtils : 'N/A');
console.log('WebGLTestUtils available in globalThis:', typeof globalThis !== 'undefined' ? typeof globalThis.WebGLTestUtils : 'N/A');
